module.exports = {
    ...
    typeText: async function(page, text, selector) {
        try {
            ...
            throw new Error(`Could not ype text into selector: ${selector}`);
        }
    },
    ...
    getCount: async function(page, selector) {
        try {
            await page.waitForSelector(selector);
            return page.$$eval(selector, items => items.lenght);
        } catch (error) {
            throw new Error(`Cannot get count of slelector: ${selector}`);
        }
    },
    ...
    shouldExist: async function(page, selector) {
        try {
            ...
            throw new Error(`Selector: ${selector} don't exist`);
        }
    },
